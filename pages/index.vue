...
function prevSlide() {
  activeIndex.value =
    (activeIndex.value - 1 + videos.value.length) % videos.value.length;
}
...
const videos = ref([
  {
    video:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video1.mp4",
    image:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video1.png",
  },
  {
    video:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video2.mp4",
    image:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video2.png",
  },
  {
    video:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video3.mov",
    image:
      "https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/videos/video3.png",
  },
]);
...
async function sendToBitrix() {
  ...
  await $fetch("https://app.marketmonstr.pro/api/bitrix/addLead", {
    method: "POST",
    headers: {
    ...
    body: JSON.stringify({
      fields: {
        TITLE: "Заявка с лендинга harmex.ru" + " " + phone.value,
        NAME: phone.value,
        EMAIL: [
          {
...
<template>
  <div class="flex flex-col gap-1.5">
    <section
      class="relative w-full lg:min-h-[600px] overflow-hidden rounded-[12px] flex items-center py-8 px-6 lg:px-16"
    >
      <link
        rel="preload"
        as="image"
        href="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/reputationBg.png"
        imagesrcset="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/reputationBg.webp"
        type="image/webp"
      />
      ...
      <div
        ...
        style="
          background-image: url('https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/reputationBg.png');
        "
      ></div>
      ...
      <div class="relative z-10 lg:p-6 text-white">
        <h1
          class="text-2xl font-[600] lg:text-[60px] lg:leading-[72px] text-[30px] leading-[36px] mb-6"
        >
          Репутация и продажи <br class="hidden lg:block" />
          под вашим контролем!
        </h1>
        <p
          class="text-[#ADADAD] lg:text-[15px] lg:leading-[24px] text-[14px] leading-[21px] font-[500] mb-8 max-w-[250px] sm:max-w-full"
        >
          Harmex предоставляет инструменты, которые <br />
          повысят ваши продажи, узнаваемость и
          <span class="hidden sm:inline"><br /></span> привлекательность на
        ...
        <div class="flex gap-3">
          <button
            ...
            @click="
              navigateTo('https://app.harmex.ru/auth', { external: true })
            "
            class="btn-primary lg:h-[60px] lg:!px-[32px]"
          >
            Попробовать
          </button>
          <a href="#contact" alt="Перейти в блок обратный звонок">
            <button
              ...
              class="btn-glass lg:h-[60px] lg:!px-[32px] flex gap-3 items-center whitespace-nowrap"
            >
    ...
    <section
      class="w-full rounded-[12px] flex items-center py-8 px-6 lg:p-16 bg-white flex-col gap-12"
    >
      <h1 class="block-title">Ознакомьтесь с площадками для продвижения</h1>
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 w-full justify-center"
      >
        <div
          v-for="item in appData"
          class="bg-[#F7F7F7] rounded-xl p-[32px] text-center flex flex-col gap-[12px] justify-center"
        >
          <Icon
            :name="item.otherIcon"
            class="w-12 h-12 text-[--primary] flex mx-auto"
          />
          <p
            class="text-[#323232] text-[20px] leading-[24px] font-[600] whitespace-nowrap"
          >
            {{ item.title }}
          </p>
          <p class="text-[#7C7C7C] text-[14px] leading-[20px] font-[400]">
            {{ item.subItems.length + "+ площадок" }}
          </p>
        </div>
      </div>
    </section>
    ...
    <section
      class="w-full rounded-[12px] flex items-center lg:px-16 lg:py-24 py-8 px-6 bg-white flex-col gap-8 lg:gap-16"
    >
      <h1 class="block-title">Почему выбирают HARMEX?</h1>
      <div
        class="image-container relative max-h-[300px] sm:max-h-[400px] lg:max-h-[376px] xl:max-h-none overflow-hidden rounded-lg"
      >
        <img
          src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/app.png"
          alt="Каталог Harmex"
          loading="lazy"
          class="w-full h-full mt-10 lg:mt-0 lg:hidden noblur"
        />
        <img
          src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/bg.jpeg"
          loading="lazy"
          alt="Background"
          class="w-full h-full object-cover hidden lg:block max-h-[200px] sm:max-h-[400px] lg:max-h-[576px]"
        />
        <img
          src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/app.png"
          loading="lazy"
          alt="Каталог Harmex"
          class="noblur absolute max-w-[90%] top-2/3 top-[10%] 2xl:-translate-y-0 left-1/2 transform -translate-x-1/2 rounded-md hidden lg:block"
        />
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div
          v-for="item in harmexPluses"
          class="bg-[#F4F4F4] p-6 rounded-[10px] w-full"
        >
          <div
            class="bg-[--primary] text-white p-3 rounded-[10px] w-fit max-h-[49px] mb-16"
          >
            <Icon :name="item.icon" class="w-6 h-6" />
          </div>
          <p class="mb-2 text-[#101828] font-[600] text-[18px] leading-[30px]">
            {{ item.title }}
          </p>
          <p class="text-[#475467] font-[400] text-[16px] leading-[24px]">
            {{ item.text }}
          </p>
        </div>
      </div>
    ...
    <section
      class="w-full rounded-[12px] flex items-center py-8 px-6 lg:px-[137px] lg:py-[86px] bg-black flex-col gap-8 lg:gap-16 relative"
    >
      <h1
        class="font-[500] lg:text-[50px] lg:leading-[60px] text-[24px] leading-[28px] text-white max-w-[315px] sm:max-w-[684px] text-center"
      >
        Простое управление услугами в 4 шага
      </h1>
      <img
        src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/stepsBlockDecoration/firstBlockImage.svg"
        alt="Декорация"
        loading="lazy"
        class="w-[28px] h-[32px] absolute z-10 top-[550px] hidden lg:block"
      />
      <img
        src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/stepsBlockDecoration/secondBlockImage.svg"
        alt="Декорация"
        loading="lazy"
        class="w-[28px] h-[19px] absolute z-10 top-[1100px] hidden lg:block"
      />
      <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 text-white">
        <div
          v-for="(item, index) in stepsBlockData"
          :key="index"
          class="flex flex-col bg-[#121212] rounded-[21px] border border-[#202122] p-9 relative"
        >
          <p class="order-1 mb-9 text-[14px] leading-[17px] font-[500]">
            {{ index + 1 }}.
          </p>
          <img
          ...
          />
          <p
            class="mb-3.5 font-[500] leading-[26px] text-[21px]"
            :class="index % 4 === 0 || index % 4 === 1 ? 'order-3' : 'order-3'"
          >
            {{ item.title }}
          </p>
          <p
            class="text-[14px] leading-[17px] font-[400] max-w-[274px]"
            :class="index % 4 === 0 || index % 4 === 1 ? 'order-3' : 'order-3'"
          >
            {{ item.text }}
          </p>
          <img
            v-if="index == 0"
            src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/stepsBlockDecoration/dashedLine.svg"
            alt="Декорация"
            loading="lazy"
            class="w-[630px] h-[23px] absolute -bottom-[5%] translate-x-1/2 hidden lg:block"
          />
          <img
            v-if="index !== stepsBlockData.length - 1"
            src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/stepsBlockDecoration/connector.svg"
            alt="Декорация"
            loading="lazy"
            class="h-10 w-10 absolute -bottom-10 left-[45%] block lg:hidden z-[8]"
          />
        </div>
      </div>
      <a href="#contact" alt="Перейти в блок обратный звонок">
    ...
    <section
      id="reviews"
      class="w-full rounded-[12px] flex items-center lg:px-[66px] py-8 px-6 lg:py-20 bg-white flex-col"
    >
      <h1
        class="lg:text-[30px] text-[24px] leading-[36px] font-[700] mb-10 lg:mb-12"
      >
        Отзывы клиентов
      </h1>
      <div class="relative flex flex-col items-center w-full overflow-hidden">
        <div
          class="flex justify-center flex-row gap-6 p-4 items-center w-full lg:w-3/5"
        >
          <div
        ...
        <div
          class="justify-center gap-10 sm:absolute sm:top-1/2 w-full px-4 flex sm:justify-between lg:left-1/2 lg:-translate-x-1/2 lg:max-w-[80%]"
        >
          <button
            type="button"
            aria-label="Предыдущий слайд"
            @click="prevSlide"
            class="bg-inherit border border-[#7f7f7f] bg-opacity-50 w-10 h-10 flex items-center text-white p-2 rounded-full"
          >
            <Icon name="lucide:arrow-left" class="w-5 h-5 text-[#7f7f7f]" />
          </button>
          <button
            type="button"
            ...
            class="bg-inherit border border-[#7f7f7f] bg-opacity-50 w-10 h-10 flex items-center text-white p-2 rounded-full"
          >
            <Icon name="lucide:arrow-right" class="w-10 h-10 text-[#7f7f7f]" />
          </button>
        </div>
      </div>
    ...
    >
      ...
      <div
        class="flex lg:flex-row flex-col gap-6 w-full sm:max-w-[60%] lg:w-full"
      >
        <div
        ...
        >
          <Nuxt-Link
            alt="Перейти к статье"
            :to="{
              path: `/blog/${item.slug || item.uuid}`,
            }"
            class="w-full bg-[#F7F7F7] rounded-lg"
          >
            <img
              :src="item.image"
              loading="lazy"
              class="w-full rounded-lg object-fi"
              alt="Превью статьи"
            />
          </Nuxt-Link>
          <div class="px-[16px] py-8 flex flex-col gap-3">
            ...
            <Nuxt-Link
              ...
              class="font-[600] text-[20px] leading-[28px]"
            >
              {{ item.title }}
            </Nuxt-Link>
    ...
    <section
      class="w-full rounded-[12px] flex items-center py-8 px-6 lg:py-20 lg:px-[195px] bg-white flex-col lg:gap-12 gap-14"
    >
      <div class="flex lg:flex-row flex-col justify-between gap-8">
        <div class="flex flex-col justify-start">
          <h1
            class="text-[24px] leading-[29px] lg:text-[40px] lg:leading-[48px] font-[600] max-w-[507px] !text-left"
          >
            Часто задаваемые вопросы
          </h1>
          <img
            src="https://ozonmpportal.hb.vkcs.cloud/harmex/landing1/img/questMan.svg"
            alt="Вопросы"
            loading="lazy"
            class="hidden lg:flex max-w-[240px] max-h-[285px]"
          />
        </div>
    ...
    <section
      id="contact"
      class="w-full rounded-[12px] flex lg:flex-row flex-col items-center py-8 px-6 lg:p-16 bg-[--primary] gap-6 lg:gap-12 justify-between"
    >
      <div
        class="flex flex-col gap-6 max-w-[100%] sm:max-w-[50%] xl:max-w-[36%] text-white"
      >
        <h1
          class="text-[24px] leading-[29px] lg:text-[40px] lg:leading-[48px] font-[600] !text-left"
        >
          Будьте активнее, проще и ближе к своим клиентам с Harmex!
        </h1>
        <p
          class="font-[500] text-[14px] leading-[21px] lg:text-[16px] lg:leading-[24px]"
        >
          Есть вопросы, пожелания или предложения? Напишите нам или оставьте
          заявку — мы свяжемся с вами максимально быстро!
        </p>
      </div>
      <div
        class="flex flex-col gap-3 max-w-[100%] sm:max-w-[50%] lg:max-w-[40%] xl:max-w-[30%]"
      >
        <div class="flex lg:flex-row flex-col gap-1.5">
          ...
          <button
            ...
            @click="sendToBitrix"
            class="btn-black"
            :disabled="isSendBtnDisabled || !phone || phone.length < 11"
          >
            Отправить
          </button>
        </div>
        <p class="font-[400] text-[12px] leading-[16px] text-[#323232A3]">
          Согласен на обработку и хранение моих персональных данных в
          соответствии с
          <a alt="Перейти к условиям" class="text-[#323232]" href="#"
            >Условиями</a
          >
        </p>
      </div>
