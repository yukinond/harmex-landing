...
<template>
  <div class="flex flex-col gap-0 bg-[#EAEAEA38]">
    ...
    >
      ...
      >
        Откройте полезные инсайты и советы для развития вашего бизнеса
      </h1>
      <p
        class="text-[18px] leading-[28px] font-[400] text-[#0A0A0AB2] max-w-[480px] text-center"
      >
        Всё о продвижении, репутации, маркетплейсах, интернет-магазинах и
        стриминговых платформах.
      </p>
    </section>

    <section
      class="w-full rounded-[12px] flex items-center py-8 px-6 lg:p-16 lg:py-20 bg-white flex-col gap-12"
    >
      <h1 class="block-title">Популярные статьи</h1>
      <div class="flex lg:flex-row flex-col gap-6 w-full justify-center">
        <div
          v-if="mainArticles && mainArticles.length"
    ...
    <section
      class="w-full b-white py-8 px-6 lg:px-16 lg:py-20 flex justify-center items-center"
    >
      <div
